...
import com.jkcq.antrouter.okhttp.request.OkHttpDownloadRequest;
import com.jkcq.antrouter.okhttp.request.OkHttpRequest;
import com.jkcq.antrouter.okhttp.request.OkHttpUploadRequest;
import com.jkcq.antrouter.utils.JsonUtils;
import com.jkcq.antrouter.utils.TokenUtil;
...
public class NetUtils {
    ...
    public static void doPost(String url, HashMap<String, Object> sq, final OnHttpRequestCallBack<String> callback) {
        final OkHttpRequest.Builder builder = new OkHttpRequest.Builder()
                .url(url)
                .jsonContent(JsonUtils.getInstance().toJSON(sq))
                .headers(appendHeaders())
        ...
        builder.post(new CommonTokenResultCallback<String>() {
            ...
            public void onResponse(String response) {
                if (null == response) {
                    if (callback != null) {
                        callback.onGetErrorCode(response);
                    }
                    return;
                }
    ...
    public static void doGet(String url, HashMap<String, String> sq, final OnHttpRequestCallBack<String> callback) {
        final OkHttpRequest.Builder builder = new OkHttpRequest.Builder()
                .url(url)
                .params(sq)
                .headers(appendHeaders())
        ...
        builder.get(new CommonTokenResultCallback<String>() {
...
//        headers.put("deviceId", SystemUtils.getDeviceId(BaseApp.getApp()));
        ...
        headers.put("token", TokenUtil.getInstance().getToken(AntRouterApplication.getApp()));
